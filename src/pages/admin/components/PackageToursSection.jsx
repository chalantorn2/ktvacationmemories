              ...
              {tours.length > 0 ? (
                tours.map((tour) => (
                  <tr key={tour.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-6 text-sm">{tour.location || '-'}</td>
                    <td className="py-4 px-6">
                      <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Duration / ระยะเวลา</label>
                    <select
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Province / จังหวัด</label>
                    <select
